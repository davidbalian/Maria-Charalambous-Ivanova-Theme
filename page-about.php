...
<main id="main" class="site-main">
	...
	<section class="about-hero mci-parallax" style="--mci-parallax-bg: url('<?php echo esc_url( $clinic_image_base . 'dental-art-clinic-by-dr-maria-charalambous-ivanova-reception-lobby-clinic-name.avif' ); ?>');">
		...
		<div class="container">
			<div class="about-doctor__grid">
				<div class="about-doctor__image fade-in fade-in-delay-0">
					<img src="<?php echo esc_url( trailingslashit( wp_get_upload_dir()['baseurl'] ) . '2026/02/dr-maria-charalambous-ivanova-portrait-12.webp' ); ?>" alt="Dr. Maria Charalambous-Ivanova" width="560" height="700">
				</div>
	...
	<!-- CTA Banner -->
	<section class="about-cta mci-parallax" style="--mci-parallax-bg: url('<?php echo esc_url( $clinic_image_base . 'dental-art-clinic-by-dr-maria-charalambous-ivanova-treatment-room-wide-angle-equipment.avif' ); ?>');">
