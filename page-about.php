...
<main id="main" class="site-main">
	...
	get_template_part(
		...
		array(
			...
			'subtitle' => 'Welcome to our dental clinic, where your oral health and smile are our top priorities.',
		)
	);
	?>

	<!-- Mission -->
	<section class="about-mission page-section page-section--background">
		<div class="container">
	...
	<!-- Doctor Profile -->
	<section class="about-doctor page-section page-section--surface">
		<div class="container">
			<div class="about-doctor__grid">
				...
				<div class="about-doctor__bio">
					<h2 class="fade-in fade-in-delay-1">Dr. Maria Charalambous-Ivanova <span class="text-light">DMD, MSD</span></h2>
					<p class="fade-in fade-in-delay-2">Dr. Maria Charalambous-Ivanova graduated from the University of Sofia in 2007 and has been practicing since 2008, building a dynamic and continuously evolving professional career. Through constant participation in international congresses and advanced training programs, she remains at the forefront of modern dental techniques.</p>
					<p class="fade-in fade-in-delay-3">Her specialization in <strong>composite veneers</strong> and <strong>Emax veneers</strong> forms the foundation of her aesthetic philosophy. In addition, she undertakes complex and full mouth rehabilitation cases requiring comprehensive functional analysis, precise diagnosis, and carefully structured treatment planning.</p>
					<p class="fade-in fade-in-delay-4">Each case is treated individually. There are no standardized solutions &mdash; only the right solution for the specific patient, always focusing on long-term health, proper function, and aesthetic balance.</p>
					<p class="fade-in fade-in-delay-5">Collaboration with highly skilled and specialized partners ensures optimal, natural, and harmoniously balanced results.</p>
					<ul class="about-doctor__philosophy fade-in fade-in-delay-6">
	...
	<!-- Clinic Experience -->
	<section class="about-experience page-section page-section--background">
		<div class="container">
			<h2 class="fade-in fade-in-delay-0">About the Clinic</h2>
