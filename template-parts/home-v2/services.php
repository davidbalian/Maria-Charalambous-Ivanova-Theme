...
<section class="home-services">
	<div class="container">
		<h2 class="home-services__title fade-in fade-in-delay-0"><?php mci_te( 'Our Services' ); ?></h2>
		<div class="home-services__grid fade-in fade-in-delay-1">

			<a href="<?php echo esc_url( mci_url( '/services/' ) ); ?>" class="home-services__card">
				...
				<h3 class="home-services__card-title"><?php mci_te( 'Preventative Dentistry' ); ?></h3>
			</a>
			...
			<a href="<?php echo esc_url( mci_url( '/services/' ) ); ?>" class="home-services__card">
				...
				<h3 class="home-services__card-title"><?php echo mci_t( 'Braces &amp; Orthodontic Treatment' ); ?></h3>
			</a>
			...
			<a href="<?php echo esc_url( mci_url( '/services/' ) ); ?>" class="home-services__card">
				...
				<h3 class="home-services__card-title"><?php mci_te( 'Operative Dentistry' ); ?></h3>
			</a>
			...
			<a href="<?php echo esc_url( mci_url( '/services/' ) ); ?>" class="home-services__card">
				...
				<h3 class="home-services__card-title"><?php mci_te( 'Prosthetic Dentistry' ); ?></h3>
			</a>
			...
			<a href="<?php echo esc_url( mci_url( '/services/' ) ); ?>" class="home-services__card">
				...
				<h3 class="home-services__card-title"><?php mci_te( 'Implants' ); ?></h3>
			</a>

			<a href="<?php echo esc_url( mci_url( '/services/' ) ); ?>" class="home-services__card">
				<div class="home-services__icon">
					<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v2"/><path d="M12 16v2"/><path d="M8 12H6"/><path d="M18 12h-2"/><circle cx="12" cy="12" r="3"/></svg>
				</div>
				<h3 class="home-services__card-title"><?php mci_te( 'Dental Diagnosis' ); ?></h3>
			</a>
			...
			<a href="<?php echo esc_url( mci_url( '/services/' ) ); ?>" class="home-services__card">
				...
				<h3 class="home-services__card-title"><?php mci_te( 'Cosmetic Dentistry' ); ?></h3>
			</a>
			...
			<a href="<?php echo esc_url( mci_url( '/services/' ) ); ?>" class="home-services__card">
				...
				<h3 class="home-services__card-title"><?php echo mci_t( 'Endodontics &mdash; Root Canal Treatments' ); ?></h3>
			</a>
