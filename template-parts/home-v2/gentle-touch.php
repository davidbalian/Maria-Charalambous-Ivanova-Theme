...
<section class="home-v2-gentle">
	<div class="container">
		...
		<div class="home-v2-gentle__grid">
			<div class="home-v2-gentle__card fade-in fade-in-delay-2" style="background-image: url('http://davidb1646.sg-host.com/wp-content/uploads/2026/02/dr-maria-charalambous-ivanova-portrait-04.webp');">
			...
			<div class="home-v2-gentle__card fade-in fade-in-delay-8" style="background-image: url('http://davidb1646.sg-host.com/wp-content/uploads/2026/02/dr-maria-charalambous-ivanova-portrait-09.webp');">
				<div class="home-v2-gentle__card-content">
					...
					<a href="<?php echo esc_url( home_url( '/services/' ) ); ?>" class="home-v2-gentle__card-link">Learn More</a>
				</div>
			</div>
		</div>
	</div>
