		...
		<div class="home-v2-comprehensive__grid">
			<div class="home-v2-comprehensive__box">
				<div class="home-v2-comprehensive__box-icon home-v2-comprehensive__box-icon--img">
					<img src="<?php echo esc_url( home_url( '/wp-content/uploads/2026/02/dental-veneer.avif' ) ); ?>" alt="Composite Veneers" width="32" height="32">
				</div>
			...
			<div class="home-v2-comprehensive__box">
				<div class="home-v2-comprehensive__box-icon home-v2-comprehensive__box-icon--img">
					<img src="<?php echo esc_url( home_url( '/wp-content/uploads/2026/02/emax-logo.avif' ) ); ?>" alt="Emax Veneers" width="32" height="32">
				</div>
			...
			<div class="home-v2-comprehensive__box">
				<div class="home-v2-comprehensive__box-icon home-v2-comprehensive__box-icon--img">
					<img src="<?php echo esc_url( home_url( '/wp-content/uploads/2026/02/dental-implant.avif' ) ); ?>" alt="Dental Implants" width="32" height="32">
				</div>
			...
			<div class="home-v2-comprehensive__box">
				<div class="home-v2-comprehensive__box-icon home-v2-comprehensive__box-icon--img">
					<img src="<?php echo esc_url( home_url( '/wp-content/uploads/2026/02/orthodontic.avif' ) ); ?>" alt="Orthodontics" width="32" height="32">
				</div>
			...
			<div class="home-v2-comprehensive__box">
				<div class="home-v2-comprehensive__box-icon home-v2-comprehensive__box-icon--img">
					<img src="<?php echo esc_url( home_url( '/wp-content/uploads/2026/02/tooth-filling.avif' ) ); ?>" alt="Endodontics" width="32" height="32">
				</div>
			...
			<div class="home-v2-comprehensive__box">
				<div class="home-v2-comprehensive__box-icon home-v2-comprehensive__box-icon--img">
					<img src="<?php echo esc_url( home_url( '/wp-content/uploads/2026/02/dental-care.avif' ) ); ?>" alt="Full Mouth Rehabilitation" width="32" height="32">
				</div>
