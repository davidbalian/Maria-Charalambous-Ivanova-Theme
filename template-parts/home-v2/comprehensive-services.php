...
<section class="home-v2-comprehensive">
	<div class="container">
		...
		<div class="home-v2-comprehensive__grid">
			<div class="home-v2-comprehensive__box fade-in fade-in-delay-1">
			...
			<div class="home-v2-comprehensive__box fade-in fade-in-delay-3">
				<div class="home-v2-comprehensive__box-icon home-v2-comprehensive__box-icon--img">
			...
			<div class="home-v2-comprehensive__box fade-in fade-in-delay-5">
				<div class="home-v2-comprehensive__box-icon home-v2-comprehensive__box-icon--img">
