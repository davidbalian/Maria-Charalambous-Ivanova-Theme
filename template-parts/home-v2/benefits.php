	...
	<div class="container">
		...
		<div class="home-v2-benefits__grid" data-fade-stagger>
			<div class="home-v2-benefits__card fade-in fade-in-delay-1">
				...
				<h3 class="home-v2-benefits__card-title"><?php mci_te( 'Modern dental technology' ); ?></h3>
			</div>
			<div class="home-v2-benefits__card fade-in fade-in-delay-2">
				...
				<h3 class="home-v2-benefits__card-title"><?php mci_te( 'Personalized treatment for every patient' ); ?></h3>
			</div>
			<div class="home-v2-benefits__card fade-in fade-in-delay-3">
				...
				<h3 class="home-v2-benefits__card-title"><?php mci_te( 'Comfortable and friendly environment' ); ?></h3>
			</div>
			<div class="home-v2-benefits__card fade-in fade-in-delay-4">
				...
				<h3 class="home-v2-benefits__card-title"><?php mci_te( 'High-quality dental materials' ); ?></h3>
			</div>
			<div class="home-v2-benefits__card fade-in fade-in-delay-5">
				...
				<h3 class="home-v2-benefits__card-title"><?php mci_te( 'Experienced and professional' ); ?></h3>
			</div>
		</div>
	</div>
</section>
