...
<section class="home-v2-benefits">
	<div class="container">
		...
		<div class="home-v2-benefits__grid">
			...
			<div class="home-v2-benefits__card fade-in fade-in-delay-6">
				<div class="home-v2-benefits__card-icon">
			...
			<div class="home-v2-benefits__card fade-in fade-in-delay-8">
				<div class="home-v2-benefits__card-icon">
			...
			<div class="home-v2-benefits__card fade-in fade-in-delay-10">
				<div class="home-v2-benefits__card-icon">
