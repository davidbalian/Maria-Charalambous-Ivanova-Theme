<?php
$hero_bg_url = 'https://davidb1646.sg-host.com/wp-content/uploads/2026/02/dental-art-clinic-by-dr-maria-charalambous-ivanova-treatment-room-tv-screen-dental-work.avif';
?>

<!-- Temporary full-width hero -->
<section class="home-hero home-hero--bg" style="background-image: url('<?php echo esc_url( $hero_bg_url ); ?>');">
...
<?php /* Original hero — commented out
<?php
